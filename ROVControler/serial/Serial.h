...
// platforms) it uses overlapped I/O. Windows CE doesn't allw the use
...
public:
	...
	typedef enum
	{
		...
		EBaud64000 = 64000,	// 56000 bits/sec
...
public:
	...
	virtual LONG Open (LPCTSTR lpszDevice, DWORD dwInQueue =1024, DWORD dwOutQueue = 1024, bool fOverlapped = SERIAL_DEFAULT_OVERLAPPED);
